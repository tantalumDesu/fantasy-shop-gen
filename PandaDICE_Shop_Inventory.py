...
settlement_sizes={"Thorpe": 40, "Hamlet": 100, "Village": 200, "Township": 400, "Town": 800, "Burg": 2000, "City": 5000, "Metropolis": 10000}
...
def calculate_stock(settlement_size, settlement_wealth, rarity):
    base_chance={'C': 100, 'U': 80, 'R': 8, 'E': 1}
    roll_multiplier={'C': 1, 'U': 0.5, 'R': 0.25, 'E': 0.2}
    stock_count = 0
...
# print(inventory["Stock"].head(100))
choose_shop()
buy_prompt()
